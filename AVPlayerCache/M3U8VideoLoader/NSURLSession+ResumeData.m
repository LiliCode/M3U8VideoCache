...
- (NSURLSessionDownloadTask *)downloadTaskWithIOS10ResumeData:(NSData *)resumeData
{
    ...
    if (resumeDic) {
        if (!task.originalRequest) {
            ...
            NSURLRequest *originalRequest = [NSKeyedUnarchiver unarchivedObjectOfClass:[NSURLRequest class] fromData:originalReqData error:nil];
        ...
        if (!task.currentRequest) {
            ...
            NSURLRequest *currentRequest = [NSKeyedUnarchiver unarchivedObjectOfClass:[NSURLRequest class] fromData:currentReqData error:nil];
...
- (NSData *)getCorrectRequestDataWithData:(NSData *)data
{
    ...
    if ([NSKeyedUnarchiver unarchivedObjectOfClass:[NSData class] fromData:data error:nil]) {
        return data;
    }
